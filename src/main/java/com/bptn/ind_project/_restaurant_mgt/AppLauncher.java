...
public class AppLauncher {
	...
	public static void main(String[] args) {
		...
		menuItems.add(new MenuItem("Rose", 15.00, "Drink"));
		menuItems.add(new MenuItem("Burger", 10.00, "Main"));
		menuItems.add(new MenuItem("Jack daniels", 20.05, "Drink"));
		menuItems.add(new MenuItem("Rice and Chicken", 15.20, "Main"));
		menuItems.add(new MenuItem("Ice cream", 5.00, "Dessert"));
		menuItems.add(new MenuItem("Cake", 5.00, "Dessert"));
